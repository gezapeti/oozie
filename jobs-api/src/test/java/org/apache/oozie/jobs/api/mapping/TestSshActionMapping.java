...
import org.apache.oozie.jobs.api.action.SshAction;
import org.apache.oozie.jobs.api.action.SshActionBuilder;
import org.apache.oozie.jobs.api.generated.action.ssh.ACTION;
...
public class TestSshActionMapping {
    ...
    public void testMappingSshAction() {
        ...
        final ACTION ssh = DozerMapperSingletonWrapper.instance().map(action, ACTION.class);
