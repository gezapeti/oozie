...
import org.apache.oozie.jobs.api.action.SqoopAction;
import org.apache.oozie.jobs.api.action.SqoopActionBuilder;
import org.apache.oozie.jobs.api.generated.action.sqoop.ACTION;
...
public class TestSqoopActionMapping {
    ...
    public void testMappingSqoopAction() {
        ...
        final ACTION sqoop = DozerMapperSingletonWrapper.instance().map(action, ACTION.class);

        assertEquals(jobTracker, sqoop.getJobTracker());
