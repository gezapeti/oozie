...
import org.apache.oozie.jobs.api.generated.action.spark.ACTION;
...
public class TestSparkActionMapping {
    ...
    public void testMappingSparkAction() {
        ...
        final ACTION spark = DozerMapperSingletonWrapper.instance().map(action, ACTION.class);

        assertEquals(jobTracker, spark.getJobTracker());
