...
public class TestNormalIntermediaryNode extends TestIntermediaryNode<NormalIntermediaryNode> {
    ...
    @Override
    protected NormalIntermediaryNode getInstance(final String name) {
        return new NormalIntermediaryNode(name, null);
    }

    @Test
    public void testRealNode() {
        final Node node = new MapReduceActionBuilder().build();
        final NormalIntermediaryNode instance = new NormalIntermediaryNode(NAME, node);
    ...
    public void testAddParentWhenNoneAlreadyExists() {
        final NormalIntermediaryNode parent = getInstance("parent");
