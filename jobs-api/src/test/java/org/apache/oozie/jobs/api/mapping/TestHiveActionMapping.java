...
import org.apache.oozie.jobs.api.generated.action.hive.ACTION;
...
public class TestHiveActionMapping {
    ...
    public void testMappingHiveAction() {
        ...
        final ACTION hive = DozerMapperSingletonWrapper.instance().map(action, ACTION.class);

        assertEquals(jobTracker, hive.getJobTracker());
