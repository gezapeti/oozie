...
public abstract class NodeBase {
    ...
    /**
     * Creates a new {@linked NodeBase} object with the given name.
     ...
     *
     * @throws {@link IllegalStateException} if {@code parent} is not the parent of this node.
     */
    ...
    /**
     * Adds a child to this {@link NodeBase} object.
     *
     * This method should only be used in the implementation of the {@link this#addParent} method of a subclass
     * of {@link NodeBase}, so that whenever a node is assigned a new parent, the parent also knows about the child.
     * @param child The node to be added as the child of this {@link NodeBase}.
     */
    protected abstract void addChild(final NodeBase child);

    /**
     * Removes the specified child from this {@link NodeBase} object.
     *
     * This method should only be used in the implementation of the {@link this#removeParent} method of a subclass
     * of {@link NodeBase}, so that whenever a child is removed from a node, the parent also knows about the child
     * having been removed.
