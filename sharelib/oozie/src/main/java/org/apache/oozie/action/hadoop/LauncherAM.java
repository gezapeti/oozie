...
public class LauncherAM {
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            // TODO: test case when this is not set -- see TestPigActionExecutor
    ...
    private boolean runActionMain(final String[] mainArgs, final ErrorHolder eHolder, UserGroupInformation ugi) {
        ...
        final AtomicBoolean submissionSucceeded = new AtomicBoolean(false);
        ...
        return submissionSucceeded.get();
    }
