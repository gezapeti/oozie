...
import org.apache.oozie.jobs.api.generated.action.hive2.ACTION;
...
public class TestHive2ActionMapping {
    ...
    public void testMappingHive2Action() {
        ...
        final ACTION hive2 = DozerMapperSingletonWrapper.instance().map(action, ACTION.class);

        assertEquals(jobTracker, hive2.getJobTracker());
