...
import org.apache.oozie.jobs.api.generated.action.shell.ACTION;
...
public class TestShellActionMapping {
    ...
    public void testMappingShellAction() {
        ...
        final ACTION shell = DozerMapperSingletonWrapper.instance().map(action, ACTION.class);

        assertEquals(jobTracker, shell.getJobTracker());
